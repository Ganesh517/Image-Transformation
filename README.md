...
## Register Number: 2122202300016
```python
# Image Translation
import numpy as np
import cv2
import matplotlib.pyplot as plt
input= cv2.imread("tt.jpg")
...
## vi)Image Cropping
```python
cropped_img=input[10:200,320:200]
plt.axis("off")
plt.imshow(cropped_img)
```
## Output:
### i)Image Translation
![O1](https://github.com/Ganesh517/Image-Transformation/blob/main/e51.png)


### ii) Image Scaling
![O3](https://github.com/Ganesh517/Image-Transformation/blob/main/e52.png)

### iii)Image shearing
![O4](https://github.com/Ganesh517/Image-Transformation/blob/main/e53.png)

### iv)Image Reflection
![O5](https://github.com/Ganesh517/Image-Transformation/blob/main/e54.png)


### v)Image Rotation
![O7](https://github.com/Ganesh517/Image-Transformation/blob/main/e55.png)

### vi)Image Cropping
![O8](https://github.com/Ganesh517/Image-Transformation/blob/main/e56.png)
